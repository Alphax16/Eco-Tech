...
const HeroSection =()=> {
  ...
  return (
    ...
    <MotionContainer maxW={'10xl'}  height={{lg: '100vh', sm: '100vh', md: '50vh'}} backgroundImage="url('/assets/hero_background.jpg')"
...
//   const HeroSection =()=> {
//     return (
//       <Container maxW={'8xl'} backgroundImage="url('/assets/leaves.png')"
//       backgroundSize="cover"
